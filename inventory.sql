...
(1, 'admin', 'admin', 'admin', 'admin', 'admin', '01:05:am', '01:04:am', '2018-03-07'),
(7, 'Lemuel', 'Estacio', 'lemuel', 'lemuel', 'user', NULL, NULL, NULL),
(8, 'Christian', 'Beltran', 'christian', 'monkey27', 'user', NULL, NULL, NULL);
...
INSERT INTO `issuance` (`id`, `division`, `office`, `responsibility`, `fpp`, `ris`, `sai`, `dateT`, `timeT`, `typeT`, `status`, `remarks`) VALUES
(22, '1', 'GSO', '1', '1', '3456789', '3456789', '2018-03-02', '08:29:am', 'Office Supplies', 'pending', 'asdfghjkl;''cvbnm,ertyuiokjhgfddfgkjhgfdsdfghjgfdssfdfpcvbnm,'),
